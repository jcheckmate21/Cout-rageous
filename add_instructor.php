...
//placeholders
$anumber_ph = "A NUMBER"; $password_ph = "PASSWORD"; $firstname_ph = "FIRST NAME"; $lastname_ph = "LAST NAME"; $email_ph = "EMAIL"; $major_ph = "CLASS NUMBER"; $classification_ph = "CLASSIFICATION"; $crn_ph = "CRN"; $confirm_password_ph = "CONFIRM PASSWORD"; 
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    //will take out later because it can be obtained automatically from crn
    //using Major as  variable name because I feel lazy to change it
    if(empty(trim($_POST["major"]))){
        $major_err = "Please enter your Class Number.";     
    } elseif(strlen(trim($_POST["major"])) < 2){
        $major_err = "Enter valid Class Number";
    } else{
    ...
    //but in this case, 
    //assigned "instructor" for future improvements
