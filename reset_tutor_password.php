...
<div id="mainform">
    ...
    <input id="oldpassword" type="password" name="password" class="form-control" placeholder="old password">
    ...
    <div class="form-group">
        <input id="logoutbtn" type="submit" class="btn btn-primary" value="<"><br><br><br><br>
        <div  id="reset"><a class="btn btn-link" href="instructor_dashboard.php">Cancel</a></div>
    </div>
    </form>
