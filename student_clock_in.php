...
<?php
        ...
        // Prepare an insert statement
               ...
               if($stmt = mysqli_prepare($link, $sql)){
                   ...
                   if(mysqli_stmt_execute($stmt)){
                       ...
                       <script>
                       alert("'.$firstname.$lastname.' CLOCKED IN!!!");</script>';
      ...
      function clock_out($id, $firstname, $lastname, $memo, $link){
            ...
            if($stmt = mysqli_prepare($link, $sql)){
                ...
                if(mysqli_stmt_execute($stmt)){
                    ...
                    //Display Success in pop-up
                    echo "<script>alert('".$firstname."".$lastname." CLOCKED OUT!!!');
    
                    speak('".$firstname."".$lastname." CLOCKED OUT!!!');</script>";
                    // header("location: student_login.php");
   ...
   if($row = mysqli_fetch_assoc($result)){
       ...
       echo "<script>
       alert(' No associated account found ');</script>";
