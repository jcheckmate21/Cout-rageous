...
<div>
    <div id="facebox"></div>
    <div id="sub"><input id="submit" type="submit" name="confirm_password" class="form-control" placeholder="REGISTER FACE"></div><br>
    <p id="reset1"><input type="reset" class="btn btn-default"></p>
</div>

<div id="command">
    <div>
        <a href="fingerpage.php"><div id="nextbtn">next</div></a>
